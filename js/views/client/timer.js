...
export async function handleStartClick() {
    ...
    try {
        ...
        console.error("handleStartClick error:", error);
    } finally {
        State.setIsProcessing(false);
    }
}
...
export async function handleStopClick(isAuto = false) {
    ...
    try {
        ...
        console.error("handleStopClick error:", error);
    } finally {
        State.setIsProcessing(false);
    }
}
...
export async function handleBreakClick(isAuto = false) {
    ...
    try {
        ...
        console.error("handleBreakClick error:", error);
    } finally {
        State.setIsProcessing(false);
    }
}
